...
console.log("Q#4 Part1 = " );
console.log(solarSystem.find(planet => planet.name === "Pluto"));
console.log("*******************************************");
...
solarSystem.forEach(planet => {
  ...
  console.log("Q#1 Part2 = " + system.mercury.mass);
  console.log("**************************************************");
  
  // 2. console.log the eccentricity of Venus
  console.log("Q#2 Part2 = " + system.venus.eccentricity);
  console.log("**************************************************");
  
  // 3. console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)
  const sumSatellites = parseInt(system.jupiter.satellites) + system.saturn.satellites + system.uranus.satellites + system.neptune.satellites;
  console.log("Q#3 Part2 = " + sumSatellites);
  console.log("**************************************************");
  ...
  console.log("Q#4 Part2 = Now Radiusp is: " + system.mercury.radiusp + ", and Radiuse is: " + system.mercury.radiuse);
  console.log("**************************************************");

  
  // 5. console.log Mercury's radiusp (should be 2439, not 'same')
  console.log("Q#5 Part2 = " + system.mercury.radiusp);
  console.log("**************************************************");
  ...
  const jupiterMomentum = system.jupiter.velocity * system.jupiter.mass; // momentum for Jupiter
  const plutoMomentum = system.pluto.velocity * system.pluto.mass;         // momentum for Pluto
  const momentumDifference = jupiterMomentum - plutoMomentum;                   // Difference
  console.log("Q#6 Part2 Difference in Momentum = " + momentumDifference);
  console.log("\n//////////////////***************////////////////");